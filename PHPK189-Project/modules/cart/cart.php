...
<div id="my-cart">
    ...
    <form method="post">
        ...
        <div class="cart-item row">
            ...
            <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo formatPrice($total_price);?>đ</b><a href="modules/cart/cart_del.php?prd_id=<?php echo $row['prd_id']; ?>">Xóa</a></div>
        </div>
        <?php } ?>
...
<?php }else{?>
<div class="alert alert-danger"> Giỏ hàng của bạn hiện không có sản phẩm nào! </div>
<?php
}
?>
</div>
...
<?php
    if(isset($_POST['name']) && isset($_POST['mail']) && isset($_POST['phone']) && isset($_POST['add'])){
        ...
        while($row = mysqli_fetch_array($query)){
			...
			<td width="20%">'.formatPrice($total_price).' đ</td>
		    </tr>  
            ';
        }
